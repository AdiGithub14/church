...
<div class="row awl-spacing-md" id="update_div">
	...
	<div class="container">
		...
		<div  id="cat-table-div" class="<?php if($action != "add" && $action != "update") echo'form-style-5'; ?>">
			...
			<?php if(count($all_category) == 10 ) { ?>

			<h5 class="notice notice-info notice-alt">You can only add 10 category in free version for more upgrade to our pro version</h5>
