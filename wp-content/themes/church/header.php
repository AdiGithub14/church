          ...
          <ul class="left-bar-side">
            <li>
              <p class="font-lora">
                ...
                <a href="<?php echo esc_url(home_url('/')); ?>testimony-registration"><i class="fa fa-user"></i> Sign up </a>
                <?php } ?>
              </p>
            </li>
            <li>
              <p class="font-lora">
                   ...
                   <?php /*?> <a href="<?php echo esc_url(home_url('/')); ?>testimonies"><?php
                      $current_user = wp_get_current_user();
                      echo '<span>Hello '.$current_user->user_login.'!</span>';
                    ?>
                    </a><?php */?>
                    
               <?php }else { ?>
                  <a href="<?php echo esc_url(home_url('/')); ?>testimony-login"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Login</a>
      ...
      <header class="sticky">
        <div class="container"> 
            ...
            <div class="col-md-2 col-sm-3 pull-right">
                ...
                <div class="btn-right"> <a href="<?php echo esc_url(home_url('/')); ?>give-online" class="btn "><i class="fa fa-heart-o"></i>Give Online</a> </div> <?php } ?>
            </div> 
        </div>
